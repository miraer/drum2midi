...
The toms and the hi-hats share a lane each, so they get three shades of it, dark to
light: floor, mid and high tom, and pedal, closed and open hi-hat. The middle shade is
the lane's own colour, and every shade is at least 3:1 against the window in both
